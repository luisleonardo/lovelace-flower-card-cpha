customElements.whenDefined('card-tools').then(() => {
  ...
  class FlowerCardCPHA extends cardTools.LitElement {
	...
	console.log("No plant found for entity " + this.config.entity);
      ...
      <ha-card>
        ...
        <div class="attributes">
          ...
          ${this.stateObj.attributes.conductivity ? attribute('mdi:leaf', 'conductivity', limits['min_conductivity'], limits['max_conductivity']) :
          this.stateObj.attributes.battery ? attribute('mdi:battery-high', 'battery', limits['min_battery'], limits['max_battery']) 
          : attribute('mdi:alert') }
        </div>
      </ha-card>
      ${!this.stateObj.attributes.conductivity &&  !this.stateObj.attributes.battery ? condOrBatError : ''}
      `;
    }
  ...
  customElements.define('flower-card-cpha', FlowerCardCPHA);
});

window.setTimeout(() => {
  if(customElements.get('card-tools')) return;
  customElements.define('flower-card-cpha', class extends HTMLElement{
